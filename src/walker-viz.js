...
class WalkerSimulation {
    constructor() {
        ...
        // Add click handler to background to deselect nodes
        ...
        // Update info container with dataset details - ONLY ONCE
        ...
        // Add statistics and node details to controls container - ONLY ONCE
